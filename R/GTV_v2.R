...
#'@import glmnet
#'@export
GTV_v2<-function(X,y,Sigma,delta,lam_ridge,lam_1TV=NULL,family=c("gaussian","binomial"),nlambda = 100,
  ...
  if (family == "gaussian") {
    ...
    coef_std = r$coef_std; lam_1TV = r$lam_1TV; iters=NULL
      ...
      coef_std = r$coef_std; lam_1TV = r$lam_1TV; iters=r$iters
  }
